...
const parseClass = (character) => {
  ...
  switch (charClass) {
    case 'mage':
      ...
      possibleLines.push(
        `"Oh, a mage? That's an impressive craft, friend. Have a glass of brandy on the house!". Aurelius smiles.\n`,
        `"Oh, a mage? I'm impressed your types haven't blown up all of the world yet. No magic allowed in my inn!". Aurelius seems annoyed by the fact that you're a mage.\n"`
      );
      break;
    case 'warrior':
      ...
      possibleLines.push(
        `"You look strong, friend. Here in Bruma we have Nord ancestry. We value strength and courage.". Aurelius smiles.\n`,
        `"A fellow warrior? I respect warriors. Here's a mug of mead on the house!". Aurelius smiles.\n`
      );
      break;
    case 'ranger':
      ...
      possibleLines.push(
        `"Oh, you fancy the bow? Smart techniques. Bet you never run out of good meat to eat, huh?". Aurelius laughs.\n`,
        `"A hunter! Hunters and farmers alike are the ones who provide us with food. May your hunt be fruitful, friend!". Aurelius smiles.\n`
      );
      break;
    case 'peasant':
...
const parseRace = (character) => {
  ...
  if (race.includes("orsimer") || race.includes("orc")) {
    ...
    possibleLines.push(
      ...
      `"You may stay, but I'm watching you, damn elf. One false movement and I'll have you thrown in the Lake Rumare!"\n`,
    ...
    possibleLines.push(
      `"Welcome, friend! How can I help a Nord visiting Bruma?"\n`,
      `"You must be cold, friend. Here, have a mug of mead on the house.". He hands you a mug of mead.\n`
    );
  } else if (race == 'breton') {
    possibleLines.push(
      `"Oh, a midget. How can I help you, friend?", Aurelius laughs.\n`,
      `"A Breton in these parts? Are you lost, friend?"\n`
    );
  } else if (race == 'imperial') {
    possibleLines.push(
      `"Good day, friend! How can I help a fellow Imperial?"\n`,
      `"Bruma may be cold, but our hearts are warm. Welcome to the Spelunkin' Rat, friend!"\n`
    );
    ...
    possibleLines.push(
      `"Good day, friend. Keeping well? It's a long way from Hammerfell. Enjoy your stay in Bruma."\n`,
      `"A Redguard? You're good people. Loyal to the Empire and good-hearted. Welcome to my inn."\n`
    );
  } else {
    possibleLines.push(
      `"Oh, you're a weird one, aren't you?". He laughs. "What race are you, ${character.gender == 'male' ? 'lad' : 'lass'}?"`,
      `"Oh, you're a weird one. What race are you? Doesn't matter, my family and I don't judge. What do you need, friend?". Aurelius smiles.\n`,
      `"Oh... hello...". Aurelius looks at you and raises his eyebrow. He's clearly confused because you don't look like any known race. "Do... you... need something?"\n`,
      `"Oh... you're on of those... people.". Aurelius looks at you and raises his eyebrow. He's clearly confused because you don't look like any known race. "Do you... need something?"\n`
    );
  }
}
 ...
 */
 encounterDB = {
  ...
  sabreCatAttack: {
    encounterID: 'mountainLionAttack',
    triggers: ["(spot|see|find).*mountain lion(|s).*", '(walk|run|stroll|rid(e|ing)).*(woods|road(|s)*)', "enter.*(cave|warren|thicket).*"],
    chance: 50,
    duration: 5,
    messageString: 'Mountain lion attack!',
    contextNotes: ['You are being attacked by a mountain lion!', 'A mountain lion is attacking you!'],
    endTriggers: ["(kill|scare).*mountain lion(|s)"],
    textNotes: [
      `You hear some roaring, but you can't tell what animal it is. But it sounds angry... and hungry. You hear it getting close, and you start to feel uneasy. When you turn around... it's a mountain lion!`
    ],
    outputLock: true,
    inputLock: false,
    branches: [
      {
        branchID: 'packMountainLionAttack',
        branchChance: 10,
        branchTextNotes: [`You hear some roaring... and it sounds like there's more than one animal tracking. You start to feel uneasy, as you're sure you're about to be attacked. When you turn arround... it's a pack of mountain lions!`],
      }
    ]
  },
  trollAttack: {
