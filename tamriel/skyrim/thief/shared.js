...
const parseRace = (character) => {
  ...
  let possibleLines = [
    '"Welcome to the Mad Mammoth! If you need anything, talk to me. We have warm beds and quality mead!". Grog smiles.\n',
    '"Need a room? We have warm beds and nice mead!". Grog smiles.\n',
  ];
  ...
  if (race.includes("orsimer") || race.includes("orc")) {
    ...
    `"Oh, a midget. How can I help you, friend?", Grog laughs.\n`,
    ...
    possibleLines.push(
      ...
      `"Oh, you're a weird one. What race are you? Doesn't matter, my family and I don't judge. What do you need, friend?". Grog smiles.\n`,
      `"Oh... hello...". Grog looks at you and raises his eyebrow. He's clearly confused because you don't look like any known race. "Do... you... need something?"\n`
      `"Oh... you're on of those... people.". Grog looks at you and raises his eyebrow. He's clearly confused because you don't look like any known race. "Do you... need something?"\n`
    );
  }
...
function setupNamelist() {
 ...
 state.names = ["Aby","Aage","Aakesh","Aanon","Aarlen","Aaron","Aart","Aasta","Abarden","Abbathor","Abbathorn","Abraham","Abryn",
  ...
  "Ammdar","Amschel","Amundi","Anandra","Anastasia","Anatol","AnaGroga","Ancarion","Ancelyn","Anclaiar","Ancla´ar","Andara'an","Andaraan",
